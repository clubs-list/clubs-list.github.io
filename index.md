...
ClubsList is an example web application that will aim to provide a centralized directory for UH Manoa student clubs. Here, UH Manoa students will eventually be able to login to browse a well organized directory of all current student clubs, with brief descriptions, meeting times and locations, URLs to their websites (if any), contact information for officers, and a few select photos
...
### Index pages (User home page, Admin home page, Club admin home page, Browse clubs by interest area(s))

ClubsList provides several public pages that present the contents of the database organized in various ways, and allows certain admins to edit and/or add their respective club information.

The User home page shows all the current clubs which can then be sorted to there intrests, timestamps, etc.:

<!-- ![](images/profiles-page.png) -->

The Admin home page shows all the current clubs and allows them to monitor the site for inappropriate content, and create new categories of musical tastes, capabilities, and goals:

<!-- ![](images/projects-page.png) -->

The Club admin page shows all the current clubs and allows them to edit the data associated with their club:
...
We are interested in your experience using ClubsList! <!-- If you would like, please take a couple of minutes to fill out the [Bowfolios Feedback Form](https://forms.gle/hBHdccQEbm4YNfPd6). It contains only five short questions and will help us understand how to improve the system. -->
...
It's significantly easier to do development with ESLint integrated directly into your IDE (such as VS Code).
...
The development process for ClubsList conformed to [Issue Driven Project Management](http://courses.ics.hawaii.edu/ics314f19/modules/project-management/) practices. In a nutshell:
...
The following sections document the development history of ClubsList.
